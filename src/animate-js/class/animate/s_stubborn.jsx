...
export const descriptionS = [
    `개인적으로 전 고집이 세고, 고지식한 편이라고 생각해요. 
    예를 들자면, 법이나 규정의 빈틈을 찌르는 걸 좋아하지 않아요. 
    또 문제를 해결할 때 우회책을 사용하기보다는 정공법으로 해결하려고 합니다.
    원칙주의적이라고도 볼 수 있겠네요.`,
    `가끔은 "넌 너무 FM대로 해", "이 정도는 괜찮아"라는 식의 핀잔을 듣고는 합니다.
    너무 융통성 없게 행동해서 되려 손해를 본다는 거죠.
    저도 동의합니다. 가끔은 제가 생각해도 과하다고 볼 때가 있어요. 남들이 보기엔 답답할 수도 있겠죠.`,
    `그렇지만 전 제 고집이 꼭 나쁘다고 생각하지는 않아요.
    오히려 요즘 같은 세상에서는 이런 FM스러운 삶의 방식이 나쁘지 않을 수 있죠.
    원칙을 지키는 게 하나의 방어 수단이 될 수 있으니까요.
    스스로를 지켜야 하는 차가운 사회에서, 원칙을 지키면 적어도 공격받을 구석은 줄어들 거라고 생각해요.`,
    `물론 때로는 융통성 있게, 유연하게 대처해야 할 때도 있다는 건 알고 있습니다.
    "융통성"과 "원칙주의", 둘 사이의 적절한 균형을 찾는 게 참 어렵네요.`
];

export const toolTipS = [
    `글자나 배경을 잡고 움직이면 글자가 변형됩니다.`,
    `잡고 있던 걸 놓으면 글자가 원래대로 돌아옵니다.`,
];
