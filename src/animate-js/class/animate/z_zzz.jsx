...
export const descriptionZ = [
    `개인적으로 "잠"을 정말 소중하게 여기는 편입니다.
    불면증을 꽤 길게 앓았거든요.`,
    `대학 2학년부터 시작된 것으로 기억하는데, 잠을 자면 거의 세시간마다 깼어요.
    그래도 그때는 금방 잠들었으니 버틸만 했습니다. 
    그런데 4학년부터는 아예 잠들기까지 몇 시간씩 걸리게 되었습니다. 
    이건 좀 힘들더라구요. 심할 때는 새벽 1시에 누워서 아침 7시에 잠들기도 했습니다.
    결국 석사 과정동안은 주 1회 정도 수면유도제를 먹어서 억지로 잤습니다.`,
    `석사 졸업 후에는 다행히 불면증이 거의 없어졌습니다. 
    아직 중간중간 깨긴 하지만 금방 잠드니까 괜찮아요.
    아주 가끔씩 잠들지 못할 때가 있는데, 그때마다 약간 무서워요. 
    "혹시나 불면증이 도진건가?" 싶더라구요.`,
    `그런 걱정이 무색하게, 요즘은 하루에 8시간 이상씩 잘 잡니다.
    마치 지금까지 못 잔 만큼 몰아 자는 느낌이에요.`
];

export const toolTipZ = [
    '이불을 끌어내리면 Zzz가 일어나서 다시 이불을 덮고 잡니다.',
    'Zzz를 여러 번 누르면 이불 속에서 뒤척거리며 짜증을 냅니다.'
];
