...
export const descriptionH = [
    `전 흔히 말하는 "집돌이"입니다. 일주일동안 집 밖으로 한발짝도 나가지 않은 적도 많아요. 
    대체로 집 밖에서 에너지가 금방 소진되는 편이라, 어느 정도 집 안에서 충전하는 시간이 필수입니다.`,
    `그러다 보니 가끔 주변인들이 이런 질문을 하곤 했습니다.`,
    `"집에만 있으면 혼자서 뭐해? 심심하지 않아?"`,
    `딱히 뭔가를 하면서 시간을 보내지는 않았어요. 그냥 멍때리거나 유튜브를 보는 등, 시간을 흘려보내는 경우가 많았죠.
    시간이 아깝다고 느끼지는 않았습니다. 제게는 이런 재충전의 시간이 필요했으니까요.`,
    `과거형 문장을 보고 눈치채신 분들도 있겠군요. 맞아요, 지금은 조금 달라졌습니다.
    취직을 한 지금은 대학원생 때보다 제 시간이 많아지다 보니 오히려 에너지가 남기도 하더라구요.
    그래서 집에만 있자니 지루함을 느끼기도 했습니다. 그래서 요새는 주말에 하루는 밖으로 나가려고 해요.
    카페를 가던지, 아니면 산책을 좀 하던지 말이죠.`,
    `물론 아직도 집에서 쉬는 게 최고라고 생각합니다. 그렇지만, 외출하는 즐거움이 있어야 집에서 쉬는 즐거움이 있는 법이더라구요.`
];

export const toolTipH = [
    '집 안의 글자 "body"를 하나씩 밖으로 끌어내 보세요.',
    '손을 놓으면 글자가 집으로 급하게 돌아갑니다.'
];
