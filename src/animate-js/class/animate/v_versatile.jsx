...
export const descriptionV = [
    `스스로 말하기엔 뭣하지만, 할 줄 아는 게 꽤 많습니다.
    나름 미감은 있는 편이라 간단한 디자인은 하는 편이고, 손재주가 좋아서 간단한 공예 정도는 곧잘 합니다.
    요새는 요리에도 재미를 붙여서, 베이킹을 가끔 취미로 하는 중이에요. 아직 초보라서 쿠키나 브라우니 같은 간단한 디저트만 만듭니다.`,
    `가끔은 주변인들이 부러워하기도 합니다. 이것저것 다 잘한다고 생각하는 것 같아요.
    "넌 뭘 하든 잘 할 것 같아"라는 말을 되게 많이 듣곤 하죠.
    그렇지만 전 이런 성향으로 인해 꽤 고민이 많았어요. 
    이것저것 다 잘하는 편이긴 하지만, 그렇다고 뭐 하나가 엄청나게 뛰어난 것도 아니었거든요.
    "내가 뭘 제일 잘하지?"라는 질문의 답을 찾기까지 참 어려움이 많았던 것 같아요.`,
    `물론 이게 복에 겨운 소리로 보일 수도 있습니다. 
    할 줄 아는 게 많다는 것은 분명 좋은 일이거든요.
    하지만 가끔은 어떤 한 분야에서 특출난 사람들이 부럽긴 해요.`
];

export const toolTipV = [
    '다용도 칼의 각 도구(드라이버, 톱, 칼, 병따개, 와인 따개)를 누르면 해당 도구 외에는 모두 숨겨집니다.',
    '다시 펼쳐진 도구를 누르면 모든 도구가 원래대로 돌아옵니다.'
];
